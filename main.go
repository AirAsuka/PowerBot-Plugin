...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/ttsvoice"     // MiniMax语音合成
...
func init() {
	...
	token := flag.String("t", "19201101", "Set AccessToken of WSClient.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana, ""}, "Power", "power", "POWER", "帕瓦"),
